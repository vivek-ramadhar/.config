...
\newcommand{\hmwkDueDate}{January 23, 2025}
\newcommand{\hmwkClass}{Intro to Number Theory}
\newcommand{\hmwkClassTime}{}
\newcommand{\hmwkClassInstructor}{Professor Hector Lomeli}
\newcommand{\hmwkAuthorName}{\textbf{Vivek Ramadhar}}
